    ...
    <div className="min-h-screen flex items-center justify-center px-8">
      <div className="flex flex-col gap-12">
        ...
        >
          ...
          >
            Every command tells a story. Through the quiet hum of terminals and the steady
            rhythm of keystrokes, each moment is preserved—the invisible threads that
            weave together days of work, exploration, and creation. This is the map of
            those journeys, rendered in color and time.
          </motion.p>
        </div>
